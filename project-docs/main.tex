...
% Pass natbib options to NeurIPS before loading the class or packages.
% This ensures NeurIPS loads natbib in numerical citation mode.
...
% NOTE I'm a little confused by this paragraph - why are we using XGBoost?
